...
/*
 | White-label license/distribution API is MASTER-ONLY and deliberately absent
 | here. A white-label build is a consumer + a leaf puller, never an issuer,
 | oversight registry, or update distributor — see
 | docs/architecture/WHITE-LABEL-LICENSE-BOUNDARY.md. This instance reaches the
 | master's endpoints OUTBOUND via App\Services\Updater\WhiteLabelUpdateClient;
 | it exposes none of them inbound. Do not re-add the register/activate/updates/
 | themes/entitlement routes here — the CI architecture-fitness test fails the
 | build if they reappear.
 */
