...
return [
    ...
    'backup' => [
        ...
        'destination' => [
            ...
            /*
             * The disk names on which the backups will be stored. NaaraSim
             * stores to Wasabi when it is configured, otherwise to the server's
             * local disk — so a fresh cPanel/VPS install has working backups
             * before any Wasabi keys are added (blueprint Section 28).
             */
            'disks' => [
                (env('WASABI_ACCESS_KEY_ID') && env('WASABI_SECRET_ACCESS_KEY') && env('WASABI_BUCKET'))
                    ? 'wasabi'
                    : 'local',
            ],
        ],
