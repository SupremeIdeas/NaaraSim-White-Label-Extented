<div class="mx-auto max-w-2xl">
    <div class="mb-6">
        <h1 class="text-xl font-bold text-slate-900 dark:text-white">Numbers hero</h1>
        <p class="text-sm text-slate-500 dark:text-slate-400">Title, description, and up to {{ $maxImages }} images for the Numbers landing interchanging-reveal hero. WebP or JPG, ≤600&nbsp;KB. Clear all to fall back to the shipped images.</p>
    </div>
