<div class="mx-auto max-w-2xl">
    <h1 class="mb-1 text-2xl font-bold text-slate-900 dark:text-slate-100">Your profile</h1>
    <p class="mb-6 text-sm text-slate-500 dark:text-slate-400">Build out your profile — it's yours, and only you decide how much to share.</p>
    ...
    <div class="mb-6 rounded-2xl border border-slate-200 nx-glass-tile p-5 dark:border-[var(--brand-card-border-dark)]">
        ...
        <p class="mt-2 text-xs text-slate-400 dark:text-slate-500">{{ $pct >= 80 ? 'Looking great — your profile is well filled in.' : 'Add a few more details to complete your profile.' }}</p>
    </div>
    ...
    <div class="space-y-6">
        ...
        <div class="rounded-2xl border border-slate-200 nx-glass-tile p-6 dark:border-[var(--brand-card-border-dark)]">
            <div class="flex items-center gap-4">
                ...
                @endif
                <div>
                    <label class="mb-1 block text-xs font-medium text-slate-500 dark:text-slate-400">Profile photo</label>
        ...
        <button type="button" wire:click="save" wire:loading.attr="disabled" wire:target="save,avatar"
            ...
            <x-icon name="check" class="h-4 w-4" /> Save profile
        </button>
    </div>
</div>
